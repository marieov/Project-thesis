...
def get_signal_from_interval(signal, channel, channel_signals, start_time, end_time, interval):
    ...
    if interval == 0: # start of the signal
        channel_signals, signal_interval, seizure = get_signal_start_interval(signal, channel, channel_signals, start_time, end_time, interval)
        ...
        if interval == (number_of_seizures*2): #last part
            channel_signals, signal_interval, seizure = get_signal_last_interval(signal, channel, channel_signals, start_time, end_time, interval)
